...
from deepst.datasets import CellHF
...
def main():
    ...
    print("loading data...")
    ts = time.time()
    fname = os.path.join(DATAPATH, 'CACHE', 'FlowHF_C{}_P{}_T{}.h5'.format(
    ...
    if os.path.exists(fname) and CACHEDATA:
        ...
        X_train, Y_train, X_test, Y_test, mmn, external_dim, timestamp_train, timestamp_test = CellHF.load_data(
